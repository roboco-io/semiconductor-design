...
- **INTENT.md Why > 문제 두 번째 bullet 갱신 ✅** (commit `4148ff5`, 2026-05-25) — UCSD ABK ICCAD invited 포함 6 인접 작업 인용. 본 raw의 trigger 직접 반영. ⚠ 직전 wording "§11"은 self-fabrication (Operating Invariant #4 적용 사례).
- **INTENT.md What > 핵심 기능 6 항목 갱신 ✅** (2026-05-25) — 6 layer 각각에 K3 차별화 italic clause 추가. K3-λ ABK 관련: L1 Process 항목에 명시 ("ABK ICCAD invited flow-agent autonomous coordination 대신 Operator-supervised KG-A determinism"). ⚠ 직전 wording "§4 (5 layer)"는 self-fabrication (INTENT.md What은 "핵심 기능" 명명, 항목 6개), Operating Invariant #4 적용 사례.
