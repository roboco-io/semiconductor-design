...
- **INTENT.md Why §11** 갱신 후보: "기존 agentic EDA는 parameter knob tuning에 한정"을 **"agentic flow / multi-agent / RL-orchestrated 다양한 시도 존재하나, *human-in-loop Operator authority* 모델과 *reasoning trace를 primary contribution*으로 결합한 사례 없음"** 으로 확장
