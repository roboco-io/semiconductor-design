...
| `raw/blogs/`, `raw/repos/`, `raw/docs/`, `raw/benchmarks/` | (현재 비어있음) | — |
...
다음 ingest 라운드는 `raw/papers/k2-*` 4개 (K2 결정 baseline — ε graph quality / ζ L1 runtime / η patch+mutation / θ benchmark+license). G1/G2/G3 spec 착수 전 결정 근거.
