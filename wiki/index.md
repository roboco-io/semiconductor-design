...
- [[tutorial-project-intro]] — 외부 개발자(칩 설계 비전문가) 30분 진입로. canonical doc은 `docs/tutorial/PROJECT_TUTORIAL.md`, 본 wiki 페이지는 6 chapter × 관련 wiki 페이지 cross-link 매핑 (2026-05-25 추가)
