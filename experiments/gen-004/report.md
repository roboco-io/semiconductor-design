# gen-004 리포트 (자율 승격 게이트)

**최종 결정: rejected_lodo**  ·  winner: `cand-003`
...
|---|---|---|---|
| cand-003 ⭐ | codex | conservative | 3.7409 |
| cand-000 | claude | conservative | 4.0791 |
| cand-001 | codex | moderate | inf |
| cand-002 | claude | aggressive | inf |

## 2) 교차설계 LODO 게이트 (held-out 설계 일반화)
# 교차설계 일반화 리포트 (held-out 설계 LODO · 방향성 probe)

**verdict: worse**  ·  winner 우세 설계: 1/3  ·  평균 격차(winner−baseline): +0.0150

| 설계(held-out) | naive | baseline | winner | 검증 |
|---|---|---|---|---|
| aes | 1.7198 | 2.6795 | 2.7255 | ✅ |
| gcd | 1.4117 | 2.5208 | 2.5054 | ✅ |
| ibex | 12.8071 | 2.9618 | 2.9762 | ✅ |
